...
<html>
    ...
    <body>
        <div class="container">
            <div id="logo_inicial" class="row">
                Gerenciador de Produtos
            </div>
            <div class="row">
                <div class="col-sm">
                    <a href="produtos.php" class="card text-center">
                ...
                <div class="col-sm">
                    <a href="vendedores.php" class="card text-center">
                ...
                <div class="col-sm">
                    <a href="vendas.php" class="card text-center">
                ...
                <div class="col-sm">
                    <a href="relatorios.php" class="card text-center">
                        <svg class="bi bi-graph-up icone_inicial" width="10em" height="10em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
