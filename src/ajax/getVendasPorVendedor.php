...
if(isset($_GET["ano"]) && isset($_GET["id_vendedor"])){
    ...
    $datasetA = $analyst->vendasPorVendedor($_GET["id_vendedor"], $_GET["ano"]);
    ...
    if( is_numeric($_GET['id_vendedor_comparar']) ){
        ...
        $datasetB = $analyst->vendasPorVendedor($_GET["id_vendedor_comparar"], $_GET["ano"]);
    ...
    $chartConfig = $analyst->prepareForVisualAnalysis("bar", $datasets);
